...
class CFG:
    ...
    student='/home/yuki/RANZCR/input/startingpointschestx/resnet200d_320_chestx.pth'
    teacher='/home/yuki/RANZCR/input/005-training-resnext-step1-data/resnet200d_320_fold1_best_loss_cpu.pth'
    weights=[0.5, 1]
    size=640
...
class CustomLoss(nn.Module):
    def __init__(self, weights, focal_loss):
    ...
    def forward(self, teacher_features, features, y_pred, labels):
        ...
        cls_loss = self.focal_loss(y_pred, labels)
...
#     model.load_state_dict(state['model'])
    ...
    # loop
    # ====================================================
    train_criterion = CustomLoss(weights=CFG.weights, focal_loss=FocalLoss(CFG.alpha, CFG.gamma))
