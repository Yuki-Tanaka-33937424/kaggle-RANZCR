...
train = pd.read_csv('/home/yuki/RANZCR/input/oof-df-data/train_folds.csv')
...
class CFG:
    ...
    student='/home/yuki/RANZCR/input/006-training-resnext-step2-data/resnet200d_320_fold0_best_loss.pth'
    epochs=5
...
class CustomResNet200D(nn.Module):
    def __init__(self, model_name='resnet200d_320', pretrained=False):
        ...
        if pretrained:
            pretrained_path = '/home/yuki/RANZCR/input/resnet200d-pretrained-weight/resnet200d_ra2-bdba9bf9.pth'
