...
class CFG:
    ...
    student='/home/yuki/RANZCR/input/startingpointschestx/tf_efficientnet_b5_ns_chestx.pth'
...
class CustomEfficientNetB5ns(nn.Module):
    def __init__(self, model_name='tf_efficientnet_b5_ns', pretrained=False):
        ...
        if pretrained:
            pretrained_path = '/home/yuki/RANZCR/input/startingpointschestx/tf_efficientnet_b5_ns_chestx.pth'
